...
struct EqualWidthHStack: Layout {
    ...
    func sizeThatFits(proposal: ProposedViewSize, // size proposal for layouts container view
        ...
        return CGSize(width: maxSize.width * CGFloat(subviews.count) + totalSpacing, // this is the ideal size the layout needs to layout all views in the largest view width with spacings
